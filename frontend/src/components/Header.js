    ...
    <header className="h-16 shadow-md bg-white fixed w-full z-40">
      <div className=" h-full container mx-auto flex items-center px-4 justify-between">
        <div className="flex items-center">
          <Link to={"/"}>
            <SiShopee className="h-10 w-10 p-1 cursor-pointer" />
          </Link>
          <h1 className=" text-emerald-600 font-bold text-2xl mt-2 mb-2 ">
            Shoppers💕
          </h1>
        </div>
          ...
          <div>
            {user?._id ? (
              <button
                ...
                className="px-3 py-1 rounded-full text-white bg-pink-600 hover:bg-pink-700"
              >
                Logout
              </button>
            ) : (
